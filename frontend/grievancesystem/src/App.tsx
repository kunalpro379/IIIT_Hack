    ...
    <Router>
      <div className={`min-h-screen relative ${
        ...
        <main className="relative container mx-auto px-4 pt-28 md:pt-32 pb-12 z-0">
          <Routes>
            <Route path="/" element={<Dashboard language={language} theme={theme} setShowForm={setShowForm} />} />
            <Route path="/statistics" element={<Statistics language={language} theme={theme} />} />
            <Route path="/announcements" element={<Announcements language={language} theme={theme} />} />
            <Route path="/community-polls" element={<CommunityPolls language={language} theme={theme} />} />
            <Route path="/discussion-forum" element={<DiscussionForum language={language} theme={theme} />} />
